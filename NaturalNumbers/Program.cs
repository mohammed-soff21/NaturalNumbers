    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                do
                {
                    if (IsNumber("a positive number to print the all natural numbers from 0 to it", out nUserNumber))
                        break;
                } while (Convert.ToBoolean(1));

                }
                // To check if the user input is positive or not
                if (!IsPositive(nUserNumber))
                    goto Validate;
                // To print the natural numbers from 1 to the user input
                PrintNaturalNumbers(nUserNumber);
        ...
        // 7) this method to check if the number is positive or not
